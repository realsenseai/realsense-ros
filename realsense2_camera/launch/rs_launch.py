...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'enable_color_nitros',          'default': 'false', 'description': 'publish the color stream as a NITROS GPU image (requires -DBUILD_WITH_NITROS=ON)'},
                           {'name': 'enable_depth_nitros',          'default': 'false', 'description': 'publish the depth stream as a NITROS GPU image (requires -DBUILD_WITH_NITROS=ON)'},
                           {'name': 'enable_aligned_depth_nitros',  'default': 'false', 'description': 'publish aligned depth as a NITROS GPU image (requires -DBUILD_WITH_NITROS=ON)'},

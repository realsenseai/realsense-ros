...
class RosbagManager(object):
    ...
    def init(self):
        self.rosbag_files = {
                "outdoors_1color.bag":"https://realsenseai.com/rs-tests/TestData/outdoors_1color.bag",
                "D435i_Depth_and_IMU_Stands_still.bag":"https://realsenseai.com/rs-tests/D435i_Depth_and_IMU_Stands_still.bag"
                }
